...
export class Thing extends EntityWithId {
    ...
    separateNamespaceAndThingId() {
        ...
        if (indexOfFirstColon >= 0) {
            ...
            const name = this.thingId.length === indexOfFirstColon
                ? ""
                : this.thingId.substring(indexOfFirstColon + 1);
...
export class Metadata extends EntityModel {
    ...
    toObject() {
        const features = this.features
            ? Features.toObject(this.features)
            : undefined;
        return EntityModel.buildObject(new Map([
            ["features", features],
            ["attributes", this.attributes],
...
export class Feature extends EntityWithId {
    constructor(_id, _definition, _properties, _desiredProperties) {
        super();
        this._id = _id;
        this._definition = _definition;
        this._properties = _properties;
        this._desiredProperties = _desiredProperties;
    }
    /**
     * Parses a Feature.
     *
