 ...
 */
export declare class WebSocketEventsHandle implements EventsHandle {
    private readonly requestFactory;
    private readonly requester;
    private events;
    private sendEventsMessage;
    private stopEventsMessage;
    private constructor();
    /**
     ...
     */
    static getInstance(builder: WebSocketRequestSenderFactory, requester: WebSocketRequestHandler): WebSocketEventsHandle;
    /**
     ...
     */
    subscribeToThing(thingId: string, callback: (message: ProtocolResponseValue) => any, action?: string, subResources?: boolean): string;
    /**
     * Registers the provided callback function. registerEvents() needs to be called first.
     ...
     * @throws Error - Throws an Error if Events were not requested by calling requestEvents()
     */
    subscribeToAttributes(thingId: string, callback: (message: ProtocolResponseValue) => any, action?: string, subResources?: boolean): string;
    /**
     * Registers the provided callback function. registerEvents() needs to be called first.
     ...
     * @throws Error - Throws an Error if Events were not requested by calling requestEvents()
     */
    subscribeToAttribute(thingId: string, attributePath: string, callback: (message: ProtocolResponseValue) => any, action?: string, subResources?: boolean): string;
    /**
     * Registers the provided callback function. registerEvents() needs to be called first.
     ...
     * @throws Error - Throws an Error if Events were not requested by calling requestEvents()
     */
    subscribeToFeatures(thingId: string, callback: (message: ProtocolResponseValue) => any, action?: string, subResources?: boolean): string;
    /**
     * Registers the provided callback function. registerEvents() needs to be called first.
     ...
     * @throws Error - Throws an Error if Events were not requested by calling requestEvents()
     */
    subscribeToFeature(thingId: string, featureId: string, callback: (message: ProtocolResponseValue) => any, action?: string, subResources?: boolean): string;
    /**
     * Registers the provided callback function. registerEvents() needs to be called first.
     ...
     * @throws Error - Throws an Error if Events were not requested by calling requestEvents()
     */
    subscribeToDefinition(thingId: string, featureId: string, callback: (message: ProtocolResponseValue) => any, action?: string, subResources?: boolean): string;
    /**
     * Registers the provided callback function. registerEvents() needs to be called first.
     ...
     * @throws Error - Throws an Error if Events were not requested by calling requestEvents()
     */
    subscribeToProperties(thingId: string, featureId: string, callback: (message: ProtocolResponseValue) => any, action?: string, subResources?: boolean): string;
    /**
     * Registers the provided callback function. registerEvents() needs to be called first.
     ...
     * @throws Error - Throws an Error if Events were not requested by calling requestEvents()
     */
    subscribeToProperty(thingId: string, featureId: string, propertyPath: string, callback: (message: ProtocolResponseValue) => any, action?: string, subResources?: boolean): string;
    /**
     * Registers the provided callback function. registerEvents() needs to be called first.
     ...
     * @throws Error - Throws an Error if Events were not requested by calling requestEvents()
     */
    subscribeToDesiredProperties(thingId: string, featureId: string, callback: (message: ProtocolResponseValue) => any, action?: string, subResources?: boolean): string;
    /**
     * Registers the provided callback function. registerEvents() needs to be called first.
     ...
     * @throws Error - Throws an Error if Events were not requested by calling requestEvents()
     */
    subscribeToDesiredProperty(thingId: string, featureId: string, propertyPath: string, callback: (message: ProtocolResponseValue) => any, action?: string, subResources?: boolean): string;
    private subscribe;
    /**
...
//# sourceMappingURL=events-websocket.d.ts.map