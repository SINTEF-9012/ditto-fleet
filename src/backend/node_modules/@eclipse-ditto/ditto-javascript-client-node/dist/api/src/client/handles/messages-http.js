...
class DefaultHttpMessagesHandle {
    ...
    claim(thingId, claimMessage, options) {
        const messageOptions = options === undefined ? request_options_1.DefaultMessagesOptions.getInstance() : options;
...
exports.DefaultHttpMessagesHandle = DefaultHttpMessagesHandle;
