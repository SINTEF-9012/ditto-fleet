...
class DefaultSearchHandle {
    ...
    search(options) {
        return this.requestFactory.fetchJsonRequest({
            verb: 'GET',
            parser: response_1.SearchThingsResponse.fromObject,
...
exports.DefaultSearchHandle = DefaultSearchHandle;
