...
exports.AllSubscription = exports.StandardSubscription = exports.WebSocketRequestHandler = void 0;
...
class WebSocketRequestHandler {
    ...
    static buildRequest(topic, path, value, header) {
        return new ditto_protocol_1.DefaultDittoProtocolEnvelope(topic, header, path, value);
    }
    /**
...
exports.StandardSubscription = StandardSubscription;
/**
 * A subscription to all messages of a type.
 */
class AllSubscription extends Subscription {
