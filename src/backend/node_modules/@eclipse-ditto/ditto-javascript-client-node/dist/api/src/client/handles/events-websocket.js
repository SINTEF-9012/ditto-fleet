...
exports.WebSocketEventsHandle = void 0;
 ...
 */
class WebSocketEventsHandle {
    constructor(requestFactory, requester) {
        this.requestFactory = requestFactory;
        this.requester = requester;
        this.events = false;
        this.sendEventsMessage = requestFactory.channel === 'twin' ?
            websocket_resilience_interfaces_1.WebSocketBindingMessage.START_SEND_EVENTS : websocket_resilience_interfaces_1.WebSocketBindingMessage.START_SEND_LIVE_EVENTS;
        this.stopEventsMessage = requestFactory.channel === 'twin' ?
            websocket_resilience_interfaces_1.WebSocketBindingMessage.STOP_SEND_EVENTS : websocket_resilience_interfaces_1.WebSocketBindingMessage.STOP_SEND_LIVE_EVENTS;
    }
    /**
    ...
    subscribeToAllEvents(callback) {
        this.checkEvents();
        return this.requester.subscribe(new websocket_request_handler_1.AllSubscription(callback, 'events'));
    }
    /**
...
exports.WebSocketEventsHandle = WebSocketEventsHandle;
