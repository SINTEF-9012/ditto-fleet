...
exports.WebSocketRequestSenderFactory = exports.WebSocketRequestSender = void 0;
const request_sender_1 = require("./request-sender");
const websocket_request_handler_1 = require("./websocket-request-handler");
/**
 * Handle to send web socket requests.
 */
class WebSocketRequestSender extends request_sender_1.RequestSender {
    ...
    subscribe(options) {
        ...
        return this.requester.subscribe(new websocket_request_handler_1.StandardSubscription(options.callback, topic, path, subResources));
    }
    /**
...
exports.WebSocketRequestSender = WebSocketRequestSender;
/**
 * A Factory for a WebSocketRequestSender.
 */
class WebSocketRequestSenderFactory {
...
exports.WebSocketRequestSenderFactory = WebSocketRequestSenderFactory;
