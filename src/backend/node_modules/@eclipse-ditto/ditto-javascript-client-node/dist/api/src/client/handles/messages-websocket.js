...
exports.DefaultWebSocketMessagesHandle = void 0;
 ...
 */
class DefaultWebSocketMessagesHandle {
    ...
    subscribeToAllMessages(callback) {
        this.checkMessages();
        return this.requester.subscribe(new websocket_request_handler_1.AllSubscription(callback, 'messages'));
    }
    /**
     * Registers the provided callback function. registerMessages() needs to be called first.
    ...
    requestMessages() {
        ...
        return this.requester.sendProtocolMessage(websocket_resilience_interfaces_1.WebSocketBindingMessage.START_SEND_MESSAGES)
            .then(() => {
            this.messages = true;
        });
    }
    ...
    stopMessages() {
        ...
        return this.requester.sendProtocolMessage(websocket_resilience_interfaces_1.WebSocketBindingMessage.STOP_SEND_MESSAGES)
            .then(() => {
            this.messages = false;
        });
    }
...
exports.DefaultWebSocketMessagesHandle = DefaultWebSocketMessagesHandle;
