...
exports.ResilienceMessageBuffer = ResilienceMessageBuffer;
/**
 * A class to buffer requests that expect a response.
 */
class ResilienceRequestBuffer {
    constructor(maxBufferSize) {
        this.maxBufferSize = maxBufferSize;
    ...
    addOutstanding(id, rejectionHandler) {
        if (this.full()) {
            rejectionHandler(websocket_resilience_interfaces_1.bufferFullError);
            return false;
        }
...
exports.ResilienceRequestBuffer = ResilienceRequestBuffer;
